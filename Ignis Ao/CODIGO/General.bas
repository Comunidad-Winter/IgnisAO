...
Call BuscarEngine
    ...
    If FindPreviousInstance Then
        Call MsgBox("Argentum Online AO ya esta corriendo! No es posible correr otra instancia del juego. Haga click en Aceptar para salir.", vbApplicationModal + vbInformation + vbOKOnly, "Error al ejecutar")
        End
    End If
...
#End If
    ...
    Call AddtoRichTextBox(frmCargando.status, "                    ¡Bienvenido al Ignis Ao!", 255, 255, 255, True, False, True)
    
    Call MsgBox("Bienvenido al Ignis Ao")
