...
End Sub
Public Sub WriteDarMD(ByVal UserName As String)
With outgoingData
Call .WriteByte(ClientPacketID.DarMD)
 Call .WriteASCIIString(UserName)
 End With
 
End Sub
Public Sub WriteDarOro(ByVal UserName As String)

With outgoingData
Call .WriteByte(ClientPacketID.DarOro)
 Call .WriteASCIIString(UserName)
 End With
End Sub
Public Sub WriteDarPlata(ByVal UserName As String)
With outgoingData
Call .WriteByte(ClientPacketID.DarPlata)
Call .WriteASCIIString(UserName)
End With
End Sub
