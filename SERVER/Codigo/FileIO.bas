...
'***************************************************
    ...
    BootDelBackUp = val(GetVar(IniPath & "Server.ini", "INIT", "IniciarDesdeBackUp"))
     ...
     LAEXP = val(GetVar(IniPath & "Server.ini", "INIT", "Exp"))
     ELORO = val(GetVar(IniPath & "Server.ini", "INIT", "Oro"))
...
'***************************************************
    ...
    With Npclist(NpcIndex)
        ...
        .GiveEXP = val(GetVar(npcfile, "NPC" & NpcNumber, "GiveEXP")) * LAEXP
        
        
        .GiveGLD = val(GetVar(npcfile, "NPC" & NpcNumber, "GiveGLD")) * ELORO
